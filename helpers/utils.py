...
def get_input(filename_or_path: str = 'input.txt') -> str:
    """
    Finds the input text file, reads it, and returns it as a string.
    Searches for a filename called input.txt by default.
    """
...
def get_input_lines(filename_or_path: str = 'input.txt') -> List[str]:
    """
    Finds the input text file, reads it. Splits the string data by line ('\\n').
...
def ints(text: str, sign_prefixes: bool = True) -> Tuple[int, ...]:
    """
    Takes a single string and parses out all ints in the string.
    Uses any non-number characters as delimiters.
    """
...
def floats(text: str) -> Tuple[float, ...]:
    """
    Takes a single string and parses out all floats in the string.
    Uses any non-number and '.' characters as delimiters.
    """
